...
// Time = N * dt
// 20 * 0.05 very sharp changes and run off the track
size_t N = 10;
double dt = 0.1;
...
double w_cte = 2000.0;    // should have as little error as possible
double w_epsi = 2000.0;
double w_v = 1.0;         // less weight in v and actuators allows sharp turns to be handled well by solver
double w_delta =1.0; 
double w_a =1.0;
double w_ddelta = 200.0;  // make the steer and throttle smoother
double w_da = 10.0;
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  for (int i = delta_start; i < a_start; i++) {
    vars_lowerbound[i] = -0.436322;
    vars_upperbound[i] = 0.436322;
  }
